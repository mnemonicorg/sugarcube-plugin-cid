import {uniq, concat, get, mergeAll, curry} from 'lodash/fp';
...
const tweet = u => ({
  dem: {
    ...
    online_link: `https://twitter.com/${get('user.screen_name', u)}/status/${get('tweet_id', u)}`,
...
export const makeDem = curry(u => mergeAll([sources.defaults(u), u, sources[u._lf_source](u)]));
